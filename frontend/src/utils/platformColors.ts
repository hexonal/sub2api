...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'entrox' | 'grok'
...
const BADGE: Record<Platform, string> = {
  ...
  entrox: 'bg-teal-500/10 text-teal-600 border-teal-500/30 dark:text-teal-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  entrox: 'bg-teal-500/10 text-teal-600 dark:bg-teal-500/10 dark:text-teal-300',
...
const BORDER: Record<Platform, string> = {
  ...
  entrox: 'border-teal-500/20 dark:border-teal-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  entrox: 'bg-gradient-to-r from-teal-400 to-cyan-500',
...
const TEXT: Record<Platform, string> = {
  ...
  entrox: 'text-teal-600 dark:text-teal-400',
...
const ICON: Record<Platform, string> = {
  ...
  entrox: 'text-teal-500 dark:text-teal-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  entrox: 'bg-teal-600 text-white hover:bg-teal-700 active:bg-teal-800 dark:bg-teal-600/80 dark:hover:bg-teal-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  entrox: 'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  entrox: 'from-teal-500 to-cyan-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'entrox' || p === 'grok'
}
