<template>
  ...
  <!-- Entrox logo (aggregate platform) -->
  <svg v-else-if="platform === 'entrox'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 5.5h16v3H8.2v2h10.3v3H8.2v2H20v3H4v-13z" />
  </svg>
